...
const objectLit = key => ({key1: 'value1',key2: 'value2',key3: 'value3',});
// TODO: Uncomment the following line of code to see the output in the browser console
...
//    undefined for the line code ,and for this when it access it as the object joe already set {name: "Joe", age: "Schmoe", hometown: 100}
// 2. What is "this" when joe.scopeArrow() is invoked?
//    undefined for the line code ,and (window when it access it as this)
// 3. Explain why "this" is different when an arrow function is used.
//    with Arrow functions, since it is essentially created on the window (global) scope, it will assume this is the window.